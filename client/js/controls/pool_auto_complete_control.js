...
function _poolListToMatches(text, galleries, options) {
    return [...galleries]
        .sort((pool1, pool2) => {
...
class GalleryAutoCompleteControl extends AutoCompleteControl {
    constructor(input, options) {
        ...
        options.getMatches = (text) => {
            ...
            return new Promise((resolve, reject) => {
                GalleryList.search(query, 0, this._options.maxResults, [
                    "id",
                    "names",
                    "category",
                    "postCount",
...
module.exports = GalleryAutoCompleteControl;

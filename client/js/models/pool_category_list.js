...
const GalleryCategory = require("./pool_category.js");

class GalleryCategoryList extends AbstractList {
    constructor() {
        super();
            ...
            .then((response) => {
                return Promise.resolve(
                    Object.assign({}, response, {
                        results: GalleryCategoryList.fromResponse(
                            response.results
                        ),
                    })
                );
...
GalleryCategoryList._itemClass = GalleryCategory;
GalleryCategoryList._itemName = "poolCategory";

module.exports = GalleryCategoryList;

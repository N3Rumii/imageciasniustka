...
class Post extends events.EventTarget {
    ...
    save(anonymous) {
        ...
        if (this._isPrivate !== undefined) {
            detail.private = this._isPrivate;
        }
        if (this._whitelist !== undefined) {
            detail.whitelist = this._whitelist;
        }
    ...
    _updateFromResponse(response) {
        const map = () => ({
            ...
            _originalFileUrl: response.originalFileUrl || null,
            _originalFileFormat: response.originalFileFormat || null,

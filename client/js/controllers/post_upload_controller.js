...
class PostUploadController {
    ...
    _uploadSinglePost(uploadable, skipDuplicates, alwaysUploadSimilar) {
        ...
        return reverseSearchPromise
            .then((searchResult) => {
                ...
                let detail = this._getPostDetail();
                post.isPrivate = detail.isPrivate;
                post.whitelist = detail.whitelistUsernames;
    ...
    _getPostDetail() {
        ...
        return {
            isPrivate: view._privateCheckboxNode
                ? view._privateCheckboxNode.checked
                : false,
            whitelistUsernames: view._getWhitelistUsernames(),
        };
    }
}

...
const PostBrowserView = require("../views/post_browser_view.js");
...
class PostListController {
    constructor(ctx) {
        ...
        this._headerView.addEventListener("browse", (e) =>
            this._evtBrowse(e)
        );
    ...
    _fetchAllPosts() {
        ...
        const fetchPage = (offset) => {
            return PostList.search(query, offset, limit, fields, {}).then(
                (response) => {

...
const GallerySummaryView = require("./pool_summary_view.js");
const GalleryEditView = require("./pool_edit_view.js");
const GalleryMergeView = require("./pool_merge_view.js");
const GalleryDeleteView = require("./pool_delete_view.js");
const EmptyView = require("../views/empty_view.js");

const template = views.getTemplate("pool");

class GalleryView extends events.EventTarget {
    constructor(ctx) {
        super();
        ...
        if (ctx.section === "edit") {
            if (!this._ctx.canEditAnything) {
                ...
                this._view.showError(
                    "You don't have privileges to edit galleries."
                );
            } else {
                this._view = new GalleryEditView(ctx);
            ...
            if (!this._ctx.canMerge) {
                this._view = new EmptyView();
                this._view.showError(
                    "You don't have privileges to merge galleries."
                );
            } else {
                this._view = new GalleryMergeView(ctx);
            ...
            if (!this._ctx.canDelete) {
                this._view = new EmptyView();
                this._view.showError(
                    "You don't have privileges to delete galleries."
                );
            } else {
                this._view = new GalleryDeleteView(ctx);
                events.proxyEvent(this._view, this, "submit", "delete");
            }
        } else {
            this._view = new GallerySummaryView(ctx);
        }

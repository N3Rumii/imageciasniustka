...
class Executor:
    ...
    def execute(
        ...
        # Include the config's user in the cache key so that private
        ...
        # Use .count() which wraps in a subquery — avoids column_property
        # expansions breaking with_only_columns() on complex models (e.g. Tag).

...
class User(Base):
    ...
    password_reset_token = sa.Column(
        "password_reset_token", sa.Unicode(128), nullable=True
    )
    password_reset_token_expiration = sa.Column(
        "password_reset_token_expiration", sa.DateTime, nullable=True
    )

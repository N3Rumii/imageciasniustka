...
class PoolWhitelist(Base):
    __tablename__ = "pool_whitelist"
    ...
    def __init__(self, pool_id: int, user_id: int) -> None:
...
class Pool(Base):
    ...
    whitelist_users = sa.orm.relationship(
        "User",
        secondary="pool_whitelist",
        lazy="joined",
    )

    @property
    def is_private(self) -> bool:
        return len(self.whitelist_users) > 0
